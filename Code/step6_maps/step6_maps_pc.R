...
if(grepl("Ubuntu 18.04 LTS",sessionInfo()[[4]])){
  filez <- filez[(!gsub("_year.RData","",filez)%in%gsub("map_|.png","",dir("/mnt/oldhdd/home/zhukov/Dropbox (Zhukov research team)/XSub_upload/graphics/maps_panel_small/")))|(!gsub("_year.RData","",filez)%in%gsub("map_|.png","",dir("/mnt/oldhdd/home/zhukov/Dropbox (Zhukov research team)/XSub_upload/graphics/maps_panel/")))]
}
filez
  ...
  if(!((a=="adm1")&(cntz[k]%in%noadm1))){
    if(!((a=="adm2")&(cntz[k]%in%noadm2))){
      ...
      if(a=="clea"){
        ...
        # Fix Bolivia
        if(cntz[k]%in%c("BOL")){
          map0 <- rgeos::gBuffer(map0, width = 0, byid = TRUE)
        }
      ...
      png(paste0("D:/Dropbox (Zhukov research team)/XSub_upload/graphics/maps_panel_small/map_",gsub("_year.RData","",filez[k]),".png"),height=2,width=2*1.618,units = "in",res=100)
      ...
      # Plot
      # png(paste0("Upload/graphics/maps/map_",gsub("_year.RData","",filez[k]),".png"),height=3,width=3,units = "in",res=300)
      png(paste0("D:/Dropbox (Zhukov research team)/XSub_upload/graphics/maps_panel/map_",gsub("_year.RData","",filez[k]),".png"),height=3,width=3*1.618,units = "in",res=300)
      # layout(matrix(c(rep(1,11),2), 12, 1, byrow = TRUE))
...
if(grepl("Ubuntu 18.04 LTS",sessionInfo()[[4]])){
  filez <- filez[(!gsub(".RData","",filez)%in%gsub("map_|.png","",dir("/mnt/oldhdd/home/zhukov/Dropbox (Zhukov research team)/XSub_upload/graphics/maps_event_small/")))|(!gsub(".RData","",filez)%in%gsub("map_|.png","",dir("/mnt/oldhdd/home/zhukov/Dropbox (Zhukov research team)/XSub_upload/graphics/maps_event/")))]
}
...
lapply(list.of.packages, require, character.only = TRUE)
  ...
  # Plot (thumbnail)
  # png(paste0("Upload/graphics/maps/map_",gsub("_year.RData","",filez[k]),".png"),height=3,width=3,units = "in",res=300)
  png(paste0("D:/Dropbox (Zhukov research team)/XSub_upload/graphics/maps_event_small/map_",gsub(".RData","",filez[k]),".png"),height=2,width=2*1.618,units = "in",res=100)
  # layout(matrix(c(rep(1,11),2), 12, 1, byrow = TRUE))
  ...
  # Plot
  # png(paste0("Upload/graphics/maps/map_",gsub("_year.RData","",filez[k]),".png"),height=3,width=3,units = "in",res=300)
  png(paste0("D:/Dropbox (Zhukov research team)/XSub_upload/graphics/maps_event/map_",gsub(".RData","",filez[k]),".png"),height=3,width=3*1.618,units = "in",res=300)
  # layout(matrix(c(rep(1,11),2), 12, 1, byrow = TRUE))
  par(mar=c(1,0,0,0),xpd=NA)
  plot(test,col="lightgrey",border=NA,density=30,xlim=bbox(test)[1,],ylim=bbox(test)[2,])
  plot(test,col="lightgrey",border="black",density=30,angle=-45,add=T)
...
# Remaining only
if(grepl("Dropbox2",getwd())){
  filez <- filez[(!gsub("adm0_|.RData","",filez)%in%gsub("time_|.png","",dir("~/Dropbox2/Dropbox (Zhukov research team)/XSub_upload/graphics/time_panel_small/")))|(!gsub("adm0_|.RData","",filez)%in%gsub("time_|.png","",dir("~/Dropbox2/Dropbox (Zhukov research team)/XSub_upload/graphics/time_panel_small/")))]
}
if(grepl("w64",sessionInfo()[[1]][[1]])){
  filez <- filez[(!gsub("adm0_|.RData","",filez)%in%gsub("time_|.png","",dir("D:/Dropbox (Zhukov research team)/XSub_upload/graphics/time_panel_small/")))|(!gsub("adm0_|.RData","",filez)%in%gsub("time_|.png","",dir("D:/Dropbox (Zhukov research team)/XSub_upload/graphics/time_panel_small/")))]
}
if(grepl("Ubuntu 18.04 LTS",sessionInfo()[[4]])){
  filez <- filez[(!gsub("adm0_|.RData","",filez)%in%gsub("time_|.png","",dir("/mnt/oldhdd/home/zhukov/Dropbox (Zhukov research team)/XSub_upload/graphics/time_panel_small/")))|(!gsub("adm0_|.RData","",filez)%in%gsub("time_|.png","",dir("/mnt/oldhdd/home/zhukov/Dropbox (Zhukov research team)/XSub_upload/graphics/time_panel_small/")))]
}
...
lapply(list.of.packages, require, character.only = TRUE)
  ...
  # FIle names
  plot.name <- c(paste0("D:/Dropbox (Zhukov research team)/XSub_upload/graphics/time_panel/time_",srz,"_",cntz[k],"_",timz,".png"),paste0("D:/Dropbox (Zhukov research team)/XSub_upload/graphics/time_event/time_",srz,"_",cntz[k],"_event.png"))
  pix <- 1
  ...
  # X$TID0 <- 1:nrow(X)
  # FIle names
  plot.name <- c(paste0("D:/Dropbox (Zhukov research team)/XSub_upload/graphics/time_panel_small/time_",srz,"_",cntz[k],"_",timz,".png"),paste0("D:/Dropbox (Zhukov research team)/XSub_upload/graphics/time_event_small/time_",srz,"_",cntz[k],"_event.png"))
  pix <- 1
  if(timz%in%"day"){pix <- 1:2}
  for(i in pix){
  png(plot.name[i],height=3,width=13,units="in",res=300)
