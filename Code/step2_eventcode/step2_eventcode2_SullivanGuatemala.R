...
# List of files
filez <- dir("Output/Output_SullivanGuatemala/Events")
filez <- filez[grep("Events",filez)]
cntz <- gsub("SullivanGuatemala_Events_|.RData","",filez)
#cntz <- cntz[cntz!="000"]
cntz
...
# Load events
load(paste0("Output/Output_SullivanGuatemala/Events/SullivanGuatemala_Events_",cntz[k],".RData",sep=""))
...
for(a in 0:2){print(a)
  ...
  if(!((a==1)&(cntz[k]%in%noadm1))){
    if(!((a==2)&(cntz[k]%in%noadm2))){
      ...
      adm.year <- agg.data
      head(adm.year)
      save(adm.year,file=paste0("Output/Output_SullivanGuatemala/SullivanGuatemala_",cntz[k],"_adm",admz,"_year.RData"))
      ...
      adm.month <- agg.data
      save(adm.month,file=paste0("Output/Output_SullivanGuatemala/SullivanGuatemala_",cntz[k],"_adm",admz,"_month.RData"))
      ...
      adm.week <- agg.data
      save(adm.week,file=paste0("Output/Output_SullivanGuatemala/SullivanGuatemala_",cntz[k],"_adm",admz,"_week.RData"))
      ...
      if(admz!=2){
        ...
        adm.day <- agg.data
        save(adm.day,file=paste0("Output/Output_SullivanGuatemala/SullivanGuatemala_",cntz[k],"_adm",admz,"_day.RData"))
      }
      # End adm2 exception
    }
  }
...
agg.data <- agg.data[order(agg.data$YSID2),]
adm.year <- agg.data
save(adm.year,file=paste0("Output/Output_SullivanGuatemala/SullivanGuatemala_",cntz[k],"_priogrid_year.RData"))
...
agg.data <- agg.data[order(agg.data$MSID2),]
adm.month <- agg.data
save(adm.month,file=paste0("Output/Output_SullivanGuatemala/SullivanGuatemala_",cntz[k],"_priogrid_month.RData"))
...
agg.data <- agg.data[order(agg.data$WSID2),]
adm.week <- agg.data
save(adm.week,file=paste0("Output/Output_SullivanGuatemala/SullivanGuatemala_",cntz[k],"_priogrid_week.RData"))
...
agg.data <- agg.data[order(agg.data$TSID2),]
adm.day <- agg.data
save(adm.day,file=paste0("Output/Output_SullivanGuatemala/SullivanGuatemala_",cntz[k],"_priogrid_day.RData"))
