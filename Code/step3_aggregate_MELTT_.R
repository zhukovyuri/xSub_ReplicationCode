...
list.of.packages <- c("plotGoogleMaps","gdata","countrycode","maptools","foreign","plotrix","sp","raster","rgeos","gdata","spatstat","parallel","foreach","doParallel","meltt")
...
mpar <- c("
          ...
          specific <- c(\"A\",\"B\")[1]
          ")
writeChar(mpar,con = "Code/step3_aggregate/step3x_melttpar.R")
...
# 
# # Set parameters
# source("Code/step3_aggregate/step3x_melttpar.R")
# 
# # Parallel computing
...
# filez.old[grep("adm2_year",filez.old)]
# cntz
# k0 <- 1; cntz[k0]; k <-k0
# 
