...
mpar <- c("
          ...
          specific <- c(\"A\",\"B\")[1]
          ")
writeChar(mpar,con = "Code/step3_aggregate/step3x_melttpar_52A_pc.R",eos = NULL)
...
# Set parameters
source("Code/step3_aggregate/step3x_melttpar_52A_pc.R")
...
cntz <- cntz[cntz%in%sapply(strsplit(filez.old,"_"),"[",2)]
cntz
filez.old[grep("adm0_year",filez.old)]
k0 <- 1; cntz[k0]; k <-k0
